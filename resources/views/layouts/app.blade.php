						...
						<div class="categories-menu mrg-xs">
							...
							<div class="category-menu-list">
								<ul>
									...
									<li><a href="#"><img alt="" src="{{ asset('assets/frontend') }}/images/icons/thum8.png"> Toys & Kids & Baby</a>
									</li>
									<li><a href="#"><img alt="" src="{{ asset('assets/frontend') }}/images/icons/thum9.png"> Automobiles </a></li>
									<li><a href="#"><img alt="" src="{{ asset('assets/frontend') }}/images/icons/thum10.png"> Jewelry & Watches</a>
									</li>
									<li><a href="#"><img alt="" src="{{ asset('assets/frontend') }}/images/icons/thum2.png"> Consumer Electronics</a>
									</li>
