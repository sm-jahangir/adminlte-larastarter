                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <select class="js-example-basic-single form-control" name="parent_category"
                                                ...
                                                <option value="{{ $parent_item->id }}" @isset($category) {{ $category->
                                                    parent_id == $parent_item->id ? 'selected' : '' }}
                                                    @endisset
                                                    >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="image" id="image" class="dropify"
                                        data-default-file="{{ isset($category) ? asset('storage/category'). '/'. $category->image : '' }}">
                                </div>

                                <div class="custom-control custom-switch">
                                    <input type="checkbox" name="status" class="custom-control-input" id="customSwitch1"
                                        @isset($category) {{ $category->status == true ? 'checked' : '' }} @endisset />
