	...
	<div class="sidebar">
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				<li class="nav-item  {{ Request::is('app/slider*') ? 'menu-open' : '' }}">
					<a href="{{ route('app.slider.index') }}" class="nav-link  {{ Request::is('app/slider*') ? 'active' : '' }}">
						<i class="nav-icon fas fa-tachometer-alt"></i>
						<p>
							Sliders
						</p>
				...
				<li class="nav-item  {{ Request::is('app/category*') ? 'menu-open' : '' }}">
					<a href="{{ route('app.category.index') }}" class="nav-link  {{ Request::is('app/category*') ? 'active' : '' }}">
						<i class="nav-icon fas fa-tachometer-alt"></i>
						<p>
							Categories
						</p>
				...
				<li class="nav-item  {{ Request::is('app/tags*') ? 'menu-open' : '' }}">
					<a href="{{ route('app.tags.index') }}" class="nav-link  {{ Request::is('app/tags*') ? 'active' : '' }}">
						<i class="nav-icon fas fa-tachometer-alt"></i>
						<p>
							Tags
						</p>
				...
				<li class="nav-item  {{ Request::is('app/brand*') ? 'menu-open' : '' }}">
					<a href="{{ route('app.brand.index') }}" class="nav-link  {{ Request::is('app/brand*') ? 'active' : '' }}">
						<i class="nav-icon fas fa-tachometer-alt"></i>
						<p>
							Brand
						</p>
				...
				<li class="nav-item  {{ Request::is('app/ads*') ? 'menu-open' : '' }}">
					<a href="{{ route('app.ads.index') }}" class="nav-link  {{ Request::is('app/ads*') ? 'active' : '' }}">
						<i class="nav-icon fas fa-tachometer-alt"></i>
						<p>
							Ads
						</p>
				...
				<li class="nav-item">
					...
					<ul class="nav nav-treeview" style="display: none;">
						<li class="nav-item">
							<a href="{{ route('app.product.index') }}" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>Products</p>
							</a>
						</li>
						<li class="nav-item">
							<a href="{{ route('app.color.index') }}" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>Color</p>
							</a>
						</li>
						<li class="nav-item">
							<a href="{{ route('app.size.index') }}" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>Size</p>
							</a>
						</li>
