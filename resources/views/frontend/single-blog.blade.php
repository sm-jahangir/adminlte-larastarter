						...
						<div class="blog-details-top">
							...
							<div class="blog-details-thumb-wrap">
								<div class="blog-details-thumb">
									<img src="{{ asset('assets/frontend') }}/images/blog/big-images/1.jpg" alt="blog images">
								</div>
							...
							<div class="blog-details-pra">
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore d aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo conse Duis aute irure dolor in reprehenderit in voluptate velit esse.
								</p>
								...
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dol orea magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate
									velit</p>
							</div>
							<!-- End Blog Pra -->
							<!-- Start Blog Tags -->
								...
								<div class="blog-comment-inner">
									...
									<div class="single-blog-comment">
										<div class="blog-comment-thumb">
											<img src="{{ asset('assets/frontend') }}/images/comment/1.jpg" alt="comment images">
										</div>
									...
									<div class="single-blog-comment comment-reply">
										<div class="blog-comment-thumb">
											<img src="{{ asset('assets/frontend') }}/images/comment/2.jpg" alt="comment images">
										</div>
										<div class="blog-comment-details">
											<div class="comment-title-date">
												<h2><a href="#">Martin Payet</a></h2>
									...
									<div class="single-blog-comment">
										<div class="blog-comment-thumb">
											<img src="{{ asset('assets/frontend') }}/images/comment/3.jpg" alt="comment images">
										</div>
										<div class="blog-comment-details">
											<div class="comment-title-date">
												<h2><a href="#">Martin Payet</a></h2>
							...
							<div class="our-recent-post-wrap">
								...
								<div class="single-recent-post">
									<div class="recent-thumb">
										<a href="blog-details.html"><img src="{{ asset('assets/frontend') }}/images/blog/sm-img/1.jpg" alt="post images"></a>
									</div>
								...
								<div class="single-recent-post">
									<div class="recent-thumb">
										<a href="blog-details.html"><img src="{{ asset('assets/frontend') }}/images/blog/sm-img/2.jpg" alt="post images"></a>
									</div>
									<div class="recent-details">
										<div class="recent-post-dtl">
											<h6><a href="blog-details.html">Lorem ipsum dolor sit amet, consectetu adipisicing elit, sed do.</a></h6>
								...
								<div class="single-recent-post">
									<div class="recent-thumb">
										<a href="blog-details.html"><img src="{{ asset('assets/frontend') }}/images/blog/sm-img/3.jpg" alt="post images"></a>
									</div>
									<div class="recent-details">
										<div class="recent-post-dtl">
											<h6><a href="blog-details.html">Lorem ipsum dolor sit amet, consectetu adipisicing elit, sed do.</a></h6>
