										...
										<div class="main-card mb-3 card">
											<div class="card-body">
												<div class="form-group">
													...
													<input type="file" name="slider_bg" id="slider_bg" class="dropify @error('slider_bg') is-invalid @enderror" @isset($slider) data-default-file="{{ asset('storage/sliders') . '/' . $slider->slider_bg }}" @endisset>
													@error('slider_bg')
														<span class="invalid-feedback" role="alert">
															<strong>{{ $message }}</strong>
														</span>
